...
export const zh = {
  'button.aria': '回退到此消息',
  'button.title': '回退',
  'button.retract.aria': '撤回预发送的消息',
  'button.retract.title': '撤回',
  'popover.title': '回退到这条消息',
  'popover.noText': '（无文本）',
  'popover.retract.title': '撤回预发送的消息',
  'popover.retract.target': '插话中 · {preview}',
  'popover.retract.confirm': '撤回',
  'popover.chat': '仅回退对话',
...
export const en = {
  ...
  'button.title': 'Rewind',
  'button.retract.aria': 'Retract pre-sent message',
  'button.retract.title': 'Retract',
  'popover.title': 'Rewind to this message',
  'popover.noText': '(no text)',
  'popover.retract.title': 'Retract pre-sent message',
  'popover.retract.target': 'Pending · {preview}',
  'popover.retract.confirm': 'Retract',
