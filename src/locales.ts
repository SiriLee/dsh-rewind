...
export const en = {
  ...
  'rewindfix.description': 'Update legacy rewind markers (A/B) in closed sessions to the current form-C shape',
  ...
  'rewindfix.args': '· rewired args target {n}',
...
export const zh: Record<HostKey, string> = {
  ...
  'rewindfix.description': '将已关闭会话中的旧版 rewind 标记（A/B）更新为当前 form-C 形态',
